...
class Vendor(Base, TimestampMixin):
    ...
    email: Mapped[str | None] = mapped_column(String(255), nullable=True)
    street: Mapped[str | None] = mapped_column(String(255), nullable=True)
    street_address_1: Mapped[str | None] = mapped_column(String(255), nullable=True)
    street_address_2: Mapped[str | None] = mapped_column(String(255), nullable=True)
    street_address_3: Mapped[str | None] = mapped_column(String(255), nullable=True)
    city: Mapped[str | None] = mapped_column(String(100), nullable=True)
    state: Mapped[str | None] = mapped_column(String(100), nullable=True)
    pincode: Mapped[str | None] = mapped_column(String(12), nullable=True)
    ...
    area_id: Mapped[uuid.UUID | None] = mapped_column(ForeignKey("area_master.id"), nullable=True)
...
class Customer(Base, TimestampMixin):
    ...
    owner_birthday: Mapped[date | None] = mapped_column(Date, nullable=True)
    gender: Mapped[Gender | None] = mapped_column(SQLEnum(Gender, name="gender"), nullable=True)
    marital_status: Mapped[str | None] = mapped_column(String(20), nullable=True)
    anniversary: Mapped[date | None] = mapped_column(Date, nullable=True)
    price_class: Mapped[str | None] = mapped_column(String(1), nullable=True)
...
class PurchaseChallanItem(Base):
    ...
    discount_mode: Mapped[str | None] = mapped_column(String(20), nullable=True)
    free_buy_quantity: Mapped[Decimal | None] = mapped_column(Numeric(18, 4), nullable=True)
    free_quantity: Mapped[Decimal | None] = mapped_column(Numeric(18, 4), nullable=True)
    effective_unit_cost: Mapped[Decimal | None] = mapped_column(Numeric(18, 4), nullable=True)
